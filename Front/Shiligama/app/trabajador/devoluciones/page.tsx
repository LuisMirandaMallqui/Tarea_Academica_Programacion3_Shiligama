...
// Sample returns data - filtered for this worker
...
export default function TrabajadorDevolucionesPage() {
  ...
  const handleAddReturn = (data: Omit<ReturnItem, "id">) => {
    const newReturn: ReturnItem = {
      ...
      registeredBy: "Carlos Mendoza", // Current worker
    }
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="lg:pl-64">
        <TrabajadorTopbar title="Devoluciones" />
        
        <main className="p-6 space-y-6">
          {/* Header */}
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold text-foreground">Mis Devoluciones</h1>
              <p className="text-muted-foreground">Gestiona las devoluciones que has registrado</p>
            </div>
