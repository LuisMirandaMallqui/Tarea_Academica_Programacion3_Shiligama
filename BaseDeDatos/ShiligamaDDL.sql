...
CREATE TABLE promocion (
  ...
  COLOR_CARRUSEL varchar(7) NOT NULL DEFAULT '#0D4525' COMMENT 'Color hexadecimal del slide en el carrusel',
  FECHA_CREACION datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Fecha automática de creación',
  FECHA_MODIFICACION datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT 'Fecha automática de última modificación',
  USUARIO_CREACION varchar(100) DEFAULT NULL COMMENT 'Nombre del usuario que creó',
  USUARIO_MODIFICACION varchar(100) DEFAULT NULL COMMENT 'Nombre del usuario que modificó',
...
CREATE TABLE boleta (
  ...
  aceptada_por_sunat tinyint DEFAULT '0',
...
ALTER TABLE pedido
ADD COLUMN STOCK_RESERVADO TINYINT NOT NULL DEFAULT 0 AFTER MONTO_TOTAL;
...
CREATE TABLE devolucion (
  ...
  MOTIVO enum('VENCIDO','DAÑADO','ERROR_PEDIDO','OTRO') DEFAULT NULL,
  MOTIVO_DETALLE varchar(500) DEFAULT NULL COMMENT 'Texto libre cuando MOTIVO = OTRO',
  OBSERVACIONES varchar(500) DEFAULT NULL,
  FECHA_HORA datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ACTIVO tinyint NOT NULL DEFAULT '1',
  FECHA_CREACION datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Fecha automática de creación',
