...
public class AdministradorBoImpl implements AdministradorBo {
    private final UsuarioDao<Administrador> daoAdministrador;
    ...
    @Override
    public Administrador buscarPorCorreo(String correo) throws Exception {
        validarTextoObligatorio(correo, "El correo es obligatorio.");
        return daoAdministrador.buscarPorCorreo(correo);
    }

    @Override
    public Administrador obtenerPorDNI(String dni) throws Exception {
        validarDNI(dni);
